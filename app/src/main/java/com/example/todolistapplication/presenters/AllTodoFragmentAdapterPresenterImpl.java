...
import com.example.todolistapplication.contracts.AllTodoFragmentAdapterContract;
...
public class AllTodoFragmentAdapterPresenterImpl implements AllTodoFragmentAdapterContract.allTodoFragmentAdapterPresenter {
    private List<Task> listTodo;
    private All_Todo_Fragment_Listener mCallBack;

    public AllTodoFragmentAdapterPresenterImpl(List<Task> listTodo, All_Todo_Fragment_Listener mCallBack){
    ...
    @Override
    public void onBindViewHolder(AllTodoFragmentAdapter.MyViewHolder holder, final int position) {
