...
public class AllTodoFragmentAdapter extends  RecyclerView.Adapter<AllTodoFragmentAdapter.MyViewHolder>{
    private AllTodoFragmentAdapterPresenterImpl presenter;


    public AllTodoFragmentAdapter(AllTodoFragmentAdapterPresenterImpl presenter){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.txtCheckBox.setOnClickListener(new View.OnClickListener() {
            @Override
